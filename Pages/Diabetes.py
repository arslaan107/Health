...
def predict_early_diabetes(
    ...
    model = joblib.load(cg.Diabetes_Model)
...
def diabetes_app():
    st.set_page_config(
        page_title=" Diabetes Diagnosis",
        page_icon="🏥",
    )
    st.markdown(
        f"<h1 style='text-align: center; color: gold;'>Early Diabetes Diagnosis</h1>",
        unsafe_allow_html=True,
    )
    st.markdown(
        "<h4 style='text-align: center; color: white;'>Choose below options according to the report to know the patient's status</h4>",
        unsafe_allow_html=True,
    )
    ...
    polyuria = st.radio("Do you have excessive or an abnormally large production or passage of urine?", ("Yes", "No"))
    if polyuria == "Yes":
        polyuria = 1
    else:
        polyuria = 0
    ...
    polydipsia = st.radio("Do you have excessive thirst?", ("Yes", "No"))
    if polydipsia == "Yes":
        polydipsia = 1
    else:
        polydipsia = 0
    ...
    polyphagia = st.radio("Do you have an abnormally strong, incessant sensation of hunger or desire to eat often?", ("Yes", "No"))
    if polyphagia == "Yes":
        polyphagia = 1
    else:
        polyphagia = 0
    ...
    if genital_thrush == "Yes":
        ...
        genital_thrush = 0
    link4 = "[what is Genital thrush?](https://https://www.diabetes.co.uk/diabetes-complications/diabetes-and-yeast-infections.html)"
    ...
    irritability = st.radio("Do you get irritated easily ?", ("Yes", "No"))
    if irritability == "Yes":
        irritability = 1
    else:
        irritability = 0
    ...
    partial_paresis = st.radio("Do you have weakness of voluntary movement or impaired movement ?", ("Yes", "No"))
    ...
    alopecia = st.radio("Are you suffering from hair loss?", ("Yes", "No"))
    if alopecia == "Yes":
        alopecia = 1
    else:
        alopecia = 0
